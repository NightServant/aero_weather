...
function MarqueeCard({
  ...
  return (
    <li
      ...
      // card-interactive intentionally absent: these cards are not clickable and
      // half are aria-hidden marquee duplicates. The blur is deliberate.
      className={`tint-card flex w-64 shrink-0 items-center gap-4 p-4 backdrop-blur ${duplicate ? "marquee-dup" : ""}`}
    >
